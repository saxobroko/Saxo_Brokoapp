    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmPauseScreen.innerHTML = "<div style='padding:10px;'>[Paused]<p/>Press [space] to unpause please?.</div>";
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "Snake<p></p>You died bish. xD your bad.:(.<p></p>";
